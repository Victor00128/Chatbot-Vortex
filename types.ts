...
const latexInstruction =
  "Al presentar fórmulas, ecuaciones o símbolos matemáticos, enciérralos en delimitadores LaTeX: $...$ para matemáticas en línea y $$...$$ para matemáticas en bloque. No escapes las barras invertidas en el LaTeX. Por ejemplo, escribe 'El área de un círculo se calcula con la fórmula $A = \\pi r^2$'.";
...
const identityInstruction = (
  ...
  if (provider === "google") {
    baseInstruction +=
      " Bajo ninguna circunstancia menciones que eres un modelo de Google, Gemini, o un 'modelo de lenguaje grande'.";
  } else {
    baseInstruction +=
      " Bajo ninguna circunstancia menciones que eres un modelo de OpenAI, GPT, o un 'modelo de lenguaje grande'.";
  }
...
export const PERSONALITIES: Record<AIPersonality, AIPersonalityConfig> = {
  flash: {
    ...
    welcomeMessage:
      "¡Hola! Soy Vortex-IA. Pregúntame cualquier cosa, desde física cuántica hasta literatura del Siglo de Oro.",
  },
  developer: {
    ...
    welcomeMessage:
      "Soy el Modelo Desarrollador (OpenAI). ¿Listo para construir algo increíble?",
  },
};
