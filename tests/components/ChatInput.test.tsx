...
describe("ChatInput", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should hide attach button for image personality type", () => {
      ...
      render(<ChatInput />);
      expect(screen.queryByRole("button", { name: /adjuntar archivo/i })).not.toBeInTheDocument();
    });
  ...
  describe("Text Input", () => {
    ...
    it("should clear input after sending message", async () => {
      ...
      expect(mockStore.sendMessage).toHaveBeenCalledWith("Test message", undefined);
  ...
  describe("File Handling", () => {
    ...
    it("should change placeholder text when file is attached", async () => {
      ...
      expect(screen.getByPlaceholderText("Pregunta sobre el archivo adjunto...")).toBeInTheDocument();
    });
    ...
    it("should send message with file attachment", async () => {
      ...
      const input = screen.getByPlaceholderText("Pregunta sobre el archivo adjunto...");
      const submitButton = screen.getByRole("button", { name: /enviar mensaje/i });

      await user.type(input, "What's in this file?");
      await user.click(submitButton);

      expect(mockStore.sendMessage).toHaveBeenCalledWith("What's in this file?", file);
    });
  });
  ...
  describe("Edge Cases", () => {
    ...
    it("should trim message before sending", async () => {
      ...
      expect(mockStore.sendMessage).toHaveBeenCalledWith("Hello world", undefined);
    });
  ...
  describe("Accessibility", () => {
    it("should have proper ARIA labels", () => {
      ...
      expect(screen.getByRole("button", { name: /adjuntar archivo/i })).toHaveAttribute("aria-label", "Adjuntar archivo");
      expect(screen.getByRole("button", { name: /enviar mensaje/i })).toHaveAttribute("aria-label", "Enviar mensaje");
    });
