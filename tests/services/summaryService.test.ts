...
describe("SummaryService", () => {
  ...
  describe("generateConversationSummary", () => {
    ...
    it("should generate summary for conversation with existing summary", async () => {
      ...
      const result = await generateConversationSummary(conversation, existingSummary);
  ...
  describe("getEnrichedContext", () => {
    ...
    it("should return summary plus recent messages when conversation is long", () => {
      ...
      const expectedRecentMessages = conversation.messages.slice(-SUMMARY_CONFIG.RECENT_MESSAGES_COUNT);
  ...
  describe("extractTopics", () => {
    it("should extract topics from summary text", () => {
      const summaryText = "Esta conversación discute programación en JavaScript, algoritmos de búsqueda, estructuras de datos como arrays y objetos, y optimización de rendimiento.";
    ...
    it("should filter out common words", () => {
      const summaryText = "Esta es una conversación sobre programación donde se discute como hacer para optimizar el código";
    ...
    it("should limit results to maximum 5 topics", () => {
      const longText = "programación javascript typescript react angular vue nodejs express mongodb postgresql redis docker kubernetes github gitlab bitbucket".repeat(5);
    ...
    it("should return most frequent words first", () => {
      const summaryText = "javascript javascript javascript react react angular";
