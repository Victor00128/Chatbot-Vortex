...
describe("ChatStore", () => {
  beforeEach(() => {
    ...
    store.editingText = "";
    store.toast = null;
    store.isGeneratingSummary = false;
  });
  ...
  describe("Message Management", () => {
    it("should add a message to a conversation", () => {
      ...
      store.newConversation();
      const conversationId = store.activeConversationId!;
      const testMessage = createTestMessage("msg-1", Sender.User, "Test message");
    ...
    it("should update a message", () => {
      ...
      store.newConversation();
      const conversationId = store.activeConversationId!;
      const testMessage = createTestMessage("msg-1", Sender.User, "Original text");
    ...
    it("should delete a message", () => {
      ...
      const remainingMessage = store.conversations[conversationId].messages.find(m => m.id === "msg-1");
