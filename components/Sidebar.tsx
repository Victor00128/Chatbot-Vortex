                ...
                >
                  {renamingId === convo.id ? (
                    <input
                      ...
                      className="w-full bg-zinc-800 border border-blue-500 rounded-md text-sm font-medium px-2 py-2 text-white outline-none focus-ring transition-all animate-message-in"
                    />
                  ) : (
                    <div
                    ...
                    >
                      ...
                      <div className="flex-shrink-0 opacity-0 group-hover/item:opacity-100 transition-all duration-200">
                        <button
                          onClick={(e) => handleMenuToggle(e, convo.id)}
                          className="p-1 text-gray-400 hover:text-white transition-all duration-200 focus-ring micro-bounce hover-scale"
