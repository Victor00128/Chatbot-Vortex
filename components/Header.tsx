        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <div className="relative">
            <select
              ...
              disabled={isLoading}
              className="appearance-none bg-zinc-800 border border-zinc-800 rounded-md py-2 pl-3 pr-8 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
