...
<div align="center">
  <a href="https://vortex-ia.netlify.app/">
    <img src="https://raw.githubusercontent.com/Victor00128/Chatbot-Vortex/main/Imagen/Chatbot-Vortex.png" width="700" alt="Banner de Vortex Chat" />
  </a>
</div>
...
Cómo funciona:
    ...
    Envías imagen: "Resuelve el ejercicio 8a" → ✅ Analiza correctamente
    Sigues preguntando: "Ahora resuelve el inciso b )" → ✅ Usa la misma imagen automáticamente
    Referencias: "Mira la foto que envié", "El mismo ejercicio", "La imagen anterior" → ✅ Funciona
